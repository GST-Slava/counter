    ...
    return (
        <div className={s.button}>
            <Button disabled={props.count === props.maxValue} onClick={props.increment} variant="contained"
                    color={props.count === props.maxValue ? "secondary" : "primary"} size="large">inc+</Button>
            <Button disabled={props.count === props.minValue} onClick={props.decrement} variant="contained"
                    color="primary" size="large">dec-</Button>
            <Button disabled={props.count === 0} onClick={props.reset} variant="contained" size="large">Reset</Button>
        </div>
    );
};